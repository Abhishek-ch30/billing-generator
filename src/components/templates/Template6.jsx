          ...
          <tbody>
            {items.map((item, index) => (
              <tr key={index}>
                ...
                <td className="p-2 text-right border border-gray-300">
                  {formatCurrency((parseFloat(item.rate) || 0) * (parseFloat(item.quantity) || 0), selectedCurrency)}
                </td>
              </tr>
            ))}
          </tbody>
          ...
          <table className="w-1/2 mb-8 border border-gray-300">
            <tbody>
              <tr>
                ...
                <td className="p-2 text-right border border-gray-300">
                  {formatCurrency(calculatedSubTotal, selectedCurrency)}
                </td>
              </tr>
              {taxPercentage > 0 && (
                <tr>
                  ...
                  <td className="p-2 text-right border border-gray-300">
                    {formatCurrency(calculatedTaxAmount, selectedCurrency)}
                  </td>
                </tr>
              )}
